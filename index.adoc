...
v0.1.0, Mon Mar 21 13:51:18 EST 2022: deprecated draft.
...
[IMPORTANT]
====
_**Dear Recruiters**_ - I only consult https://asei.systems[through ASE Inc.^] Inquire with link:mailto:contact@asei.systems?subject=We%20need%20an%20expert%2C%20please!&body=Dear%20R!dd13r%2C%0A%0A%20%20Can%20you%20please%20help%20with%20...[contact@asei.systems^]
====
...
- Attempted to motivate, modernise, and educate an all-Indian subsidiary
...
== 1992 - 1997: Software Engineer, Professional, Allentown, PA

NOTE: _Undocumented Immigrant_

- Implement UNIX daemons for mainframe business processes
- Implement devices drivers, bridges, relays, message channels
- Implement systems and platforms test software, including penetration
- 1992 - implement first commercial software, messaging channel for PDCD
...
== 1986 - 1989: Soviet Programming Competitions, Ukraine, USSR
